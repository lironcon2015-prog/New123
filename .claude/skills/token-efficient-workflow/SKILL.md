...
ולא בקשה חד-פעמית. שני סייגים שגוברים עליו, ושניהם מ-`CLAUDE.md`:

- **הבדיקות רצות במלואן לפני כל מיזוג.** "מינימום טוקנים" אינו עילה לדלג על
  סוויטה, לקצר הרצה, או להסיק שמשהו עובר בלי להריץ אותו.
- **תיעוד אינו פטפוט.** `docs/DECISIONS.md` ו-`docs/SPEC.md` מתעדכנים עם השינוי.
