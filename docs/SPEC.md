...
**מה המסמך הזה לא מכסה:** דרייב וסנכרון (שלב 5), Service Worker ומנגנון גרסה (שלב 6). מבנה הנתונים כאן כבר מכין להם מקום.
MRZ ומסך האישור נבנו בשלב 4 ומתועדים ב-§11.
...
שלו, ותאריך שאינו קיים בלוח נדחה. הפלט הולך לאותו מסך אישור ולאותם ולידטורים כמו הזנה ידנית —
